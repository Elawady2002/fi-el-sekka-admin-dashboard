                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex-1 min-w-0">
                                                <p className="font-black text-text-main truncate leading-tight">
                                                    {arrival.nameAr}
                                                </p>
                                            ...
                                            <div className="text-right flex flex-col items-end gap-2 shrink-0">
                                                <div className="p-1 px-2 bg-state-success/10 border border-state-success/20">
                                                    <p className="text-xs font-black text-state-success flex items-center gap-1">
                                                        {arrival.price} <span className="text-[8px] opacity-70">EGP</span>
                                                    </p>
                                                </div>
